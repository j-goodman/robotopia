...
Destroyer.prototype.fire = function () {
  ...
  this.destroyableStructures = ['empty', 'deposit', 'boulder', 'pipe', 'extractor', 'researchStation', 'destroyer', 'rootflower', 'root', 'strangler'];
  var direction;
  var i;
  var place;
  var plasma;
...
ResearchStation.prototype.upgrade = function (upgradeTo) {
  ...
  if (upgradeTo === 'military') {
    ...
    this.specialBuilds = ['precisionDestroyer'];
  }
