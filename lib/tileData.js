...
var tileData = {
  'boulder': {
    tag: 'boulder',
    name: "Boulder",
    description: "It's a boulder. You could get it out of the way if you built a Destroyer.",
    pipable: false,
    builds: false,
  },
  'deposit': {
  ...
  'destroyer': {
    tag: 'destroyer',
    name: "Destroyer",
    description: "A plasma-cannon based on one of the models used in the great Human Wars.",
    pipable: true,
    builds: false,
  },
  'empty': {
