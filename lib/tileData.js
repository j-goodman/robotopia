...
var tileData = {
  ...
  'powerplant': {
    ...
    pipeable: true,
    rootable: false,
    builds: ['pipe', 'extractor', 'destroyer', 'researchStation', 'fusionReactor'],
  },
  'researchStation': {
    tag: 'researchStation',
  ...
  'fusionReactor': {
    tag: 'fusionReactor',
    name: "Fusion Reactor",
    description: "A nuclear power plant that uses an electrolyzer to extract hydrogen isotopes from the moisture in its environment. Make sure it stays connected to the power grid to prevent a meltdown.",
    pipeable: true,
    rootable: false,
    builds: [],
  },
