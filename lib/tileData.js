...
var tileData = {
  ...
  'powerplant': {
    tag: 'powerplant',
    name: "Power Plant",
    description: "This is you. You're the AI controller of a giant underground battery. Anything that needs power needs to be connected to you by a pipe.",
    pipeable: true,
    rootable: false,
  ...
  'nuclearResearchStation': {
    ...
    description: "An advanced artificial intelligence scientific research station that allows you to build self-sustaining fusion reactors. The cost of building new reactors increases the more you already have.",
    pipeable: true,
    rootable: false,
    builds: ['fusionReactor'],
  },
  'fusionReactor': {
    tag: 'fusionReactor',
    name: "Fusion Reactor",
    description: "A nuclear power plant that generates a constant stream of energy. It uses an electrolyzer to extract hydrogen isotopes from the moisture in its environment. Make sure it stays connected to the power grid to prevent a meltdown.",
    pipeable: true,
    rootable: false,
    builds: ['fusionReactor'],
  },
  'munitionsFactory': {
    ...
    description: "An automated manufacturing plant designed to produce weapons based on schematics from the time of the Human Wars. Items you produce here will be immediately added to your inventory.",
    pipeable: true,
    rootable: false,
    builds: false,
  },
