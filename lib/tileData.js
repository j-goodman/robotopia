...
var tileData = {
  ...
  'deposit': {
    tag: 'deposit',
    name: "Energy Deposit",
    description: "A naturally occuring energy deposit. You can build a Salvage Camp on an adjacent tile to extract energy from it until it runs out.",
    pipeable: false,
    builds: false,
  },
  'destroyer': {
  ...
  'powerplant': {
    tag: 'powerplant',
    name: "Power Plant",
    description: "A miniature nuclear reactor to provide energy for our glorious new robot society. Connect it to mechanisms that need power by building pipes.",
    pipeable: true,
    builds: ['pipe', 'salvageCamp', 'destroyer', 'researchStation'],
  },
  'researchStation': {
    tag: 'researchStation',
