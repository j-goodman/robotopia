...
function drawPipe (i, j, viewport) {
  ...
  game.ctx.drawImage(pipeSprites[pipeKind], (j - viewport.origin.x) * 20 + viewport.pixelOffset.x, (i - viewport.origin.y) * 20 + viewport.pixelOffset.y);
}
...
function drawRoot (i, j, viewport) {
  ...
  game.ctx.drawImage(rootSprites[rootKind], (j - viewport.origin.x) * 20 + viewport.pixelOffset.x, (i - viewport.origin.y) * 20 + viewport.pixelOffset.y);
}
...
function drawSuperExtractor (i, j, viewport) {
  game.ctx.drawImage(game.tiles.superExtractor, (j - viewport.origin.x) * 20 + viewport.pixelOffset.x, (i - viewport.origin.y) * 20 + viewport.pixelOffset.y);
  if (game.grid[i][j].tenant.geoharvester) {
    game.ctx.drawImage(itemData.geoharvester.image, (j - viewport.origin.x) * 20 + viewport.pixelOffset.x, (i - viewport.origin.y) * 20 + viewport.pixelOffset.y);
  }
}

function drawGeoharvesterExtractor (i, j, viewport) {
  game.ctx.drawImage(game.tiles.extractor, (j - viewport.origin.x) * 20 + viewport.pixelOffset.x, (i - viewport.origin.y) * 20 + viewport.pixelOffset.y);
  game.ctx.drawImage(itemData.geoharvester.image, (j - viewport.origin.x) * 20 + viewport.pixelOffset.x, (i - viewport.origin.y) * 20 + viewport.pixelOffset.y);
}
...
function drawDestroyer (i, j, viewport) {
  ...
  game.ctx.drawImage(image, (j - viewport.origin.x) * 20 + viewport.pixelOffset.x, (i - viewport.origin.y) * 20 + viewport.pixelOffset.y);
}
...
function drawStrangler (i, j, viewport) {
  ...
  for (k=0 ; k<rootKinds.length ; k++) {
    ...
    game.ctx.drawImage(stranglerSprites[pipeKind + '-from-' + rootKinds[k]], (j - viewport.origin.x) * 20 + viewport.pixelOffset.x, (i - viewport.origin.y) * 20 + viewport.pixelOffset.y);
  }
}
