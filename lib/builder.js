...
builder.builds = {
  ...
  nuclearResearchStation: {
    cost: 400,
    image: 'tiles/nuclearResearchStation.png',
    name: "Nuclear Research Station",
    sound: 'woodassemble',
    tag: 'nuclearResearchStation',
  },
  fusionReactor: {
    cost: 100,
    image: 'tiles/fusionReactor.png',
    name: "Fusion Reactor",
    sound: 'pumpdrive',
    tag: 'fusionReactor',
  },
  munitionsFactory: {
    cost: 100,
    image: 'tiles/munitionsFactory.png',
    name: "Munitions Factory",
    sound: 'unsheath',
    tag: 'munitionsFactory',
  },
  chemicalPlant: {
    cost: 200,
...
builder.build = function (object, menu) {
  ...
  if (!game.builtBefore && game.settings.tutorialsOn) {
    ...
    setTimeout(function () {
      document.getElementsByClassName('textbox')[0].innerText = "Click and drag to move around the map.";
      document.getElementsByClassName('textbox')[0].style.display = 'block';
      setTimeout(function () {
        document.getElementsByClassName('textbox')[0].innerText = "";
        document.getElementsByClassName('textbox')[0].style.display = 'none';
