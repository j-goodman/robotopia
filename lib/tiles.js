...
loadTiles = function () {
  ...
  makeTile('nuclearResearchStation', true, game);
  makeTile('fusionReactor', true, game);
  makeTile('munitionsFactory', true, game);
  ...
  makeTile('resistantRootflower', true, game);
  ...
  makeTile('powerDisplay', false, game);
  makeTile('powerDisplayShort', false, game);
  makeTile('powerDisplayLong', false, game);
};
